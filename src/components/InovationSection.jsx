    ...
    <div className="w-[full] h-[full] md:h-[541px] py-[64px] gap-[64px] flex justify-center items-center content-center">
      <div className="w-[full] h-[full] md:h-[413px] grid grid-flow-row grid-cols-1 md:grid-cols-2">
        <div className="flex flex-col gap-[20px] md:items-start items-center content-center md:content-start">
          ...
          <div className="w-[400px] h-[80px] md:h-[123px]">
            <h1 className="font-futura md:text-start text-center text-[25px] md:text-[31px] text-[#223236] font-bold">
              Demonstrate branding consequently think outside
            </h1>
          </div>
          <div className="w-[434px] h-[48px]">
            <p className="font-lato text-[16px] md:text-start text-center text-[#7F7D7D]">
              Velit purus egestas tellus phasellus. Mattis eget sed faucibus
              magna vulputate pellentesque{" "}
            </p>
          </div>
          <div className="w-[495px] h-[92px] flex flex-col gap-[10px] items-center md:mb-0 mb-[54px] md:items-start ">
