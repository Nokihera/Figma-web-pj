...
const CardOne = ({ cardData }) => {
  return (
    <div
      className={`w-full max-w-[1440px] gap-8 flex flex-col sm:flex-row justify-center items-center ${
    ...
    >
      ...
      >
        <div className="flex flex-col justify-center gap-5">
          ...
          {cardData.isBtn && (
            <div>
              <button className="bg-[#6596A1] rounded-[8px] py-2 px-4 sm:px-[20px] text-white border-[1px] w-full sm:w-[148px] h-[40px] sm:h-[46px] flex items-center justify-center gap-[6px] font-lato">
                Read more
              </button>
            </div>
          )}
