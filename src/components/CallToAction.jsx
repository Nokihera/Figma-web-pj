...
const CallToAction = () => {
  return (
    <div className="w-full h-full lg:h-[439px] py-[100px] flex justify-center items-center">
      <div className=" lg:w-[1216px] w-[340px] h-full lg:h-[300px] rounded-[10px] grid grid-flow-row grid-cols-1 lg:grid-cols-2 gap-[40px] lg:gap-[80px] items-center bg-[#F0F5F6] py-[40px] px-[64px] justify-center">
        <div className=" gap-[24px] flex flex-col items-start justify-start">
          ...
          <div className="lg:w-[530px] w-full h-full md:h-[66px]">
          ...
          <div className="lg:w-[470px] w-full h-full lg:h-[48px] pb-4">
