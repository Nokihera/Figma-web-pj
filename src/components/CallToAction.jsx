...
const CallToAction = () => {
  return (
    <div className="w-full h-full md:h-[439px] py-[100px] flex justify-center items-center   ">
      <div className=" md:w-[1216px] w-[450px] h-full md:h-[300px] rounded-[10px] grid grid-flow-row grid-cols-1 md:grid-cols-2 gap-[40px] md:gap-[80px] items-center bg-[#F0F5F6] py-[40px] px-[64px] justify-center">
        <div className=" gap-[24px] flex flex-col items-start justify-start">
          <h3 className="font-futura text-[19px] md:text-[20px] text-[#6596A1]">
            Seamless Interaction
          </h3>
          <div className="md:w-[530px] w-[380px] h-full md:h-[66px]">
            <h1 className="font-futura text-[18px] md:text-[25px] text-[#223236] font-bold ">
              Welcome to your new digital reality that which will rock your
              world.
            </h1>
          </div>
          <div className="md:w-[470px] w-[380px] h-full md:h-[48px] pb-4">
