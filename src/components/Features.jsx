...
const Features = () => {
  ...
  return (
    <div className="w-full h-[763px] flex flex-col items-center py-[100px] gap-[24px]">
      <div className="w-full md:w-[1216px] h-[184px] flex flex-col items-center gap-[16px]">
        <p className="font-futura text-[#6596A1] text-[15px] md:text-[20px] border-[1px] rounded-[20px] border-[#C4C4C4] py-[8px] px:[10px] md:px-[16px] flex justify-center items-center w-[145px] h-[38px] gap-[10px] text-center">
          The Best UI
        </p>
